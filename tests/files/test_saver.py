...
class TestSaver:
    ...
    def test_function_message_status_should_return_encrypting_str(self):
        value = "Decrypting"
        exp = "Encrypting"

        assert SaveFile.message_status(value) == exp

    def test_function_message_status_should_return_decrypting_str(self):
        value = "Encrypting"
        exp = "Decrypting"

        assert SaveFile.message_status(value) == exp

    def test_function_message_status_should_return_none(self):
        value = "nothing"
        exp = None
